...
import { SyllabusSubjectList } from "@/components/sections/SyllabusSubjectList";
import {
  getBatch,
  SSC_SUBJECTS,
  HSC_SUBJECTS,
...
const HSC_DIVISIONS: Division[] = ["science"];
...
const INSTRUCTORS = [
  ...
  },
  {
    ...
    image: "/teacher image/3.png",
  },
  {
    name: "তানভীর ইসলাম",
    subject: "গণিত",
    qualification: "M.Sc, বুয়েট",
    exp: "১৫ বছরের অভিজ্ঞতা",
    image: "/teacher image/4.png",
  },
  {
    name: "নাসরিন সুলতানা",
    subject: "বাংলা",
    ...
    image: "/teacher image/5.png",
  },
  {
    name: "রাফিউল করিম",
    subject: "ইংরেজি",
    qualification: "M.A, রাজশাহী বিশ্ববিদ্যালয়",
    exp: "১১ বছরের অভিজ্ঞতা",
    image: "/teacher image/6.png",
  },
];
...
const FEATURES = [
  {
    title: "প্রশ্ন ব্যাংক",
    desc: "বিগত বছরের সব প্রশ্ন, অধ্যায় অনুযায়ী সাজানো।",
    access: "free",
    icon: "/brand/Question Bank Icon Container.svg",
  },
  {
    title: "মক টেস্ট",
    desc: "অধ্যায়ভিত্তিক ও পূর্ণ সিলেবাসের মক। সীমাহীন প্র্যাকটিস।",
    access: "paid",
    freeNote: "ফ্রিতে আজীবন ৮টি",
    icon: "/brand/Mock.svg",
  },
  {
    title: "দ্রুত প্র্যাকটিস",
    desc: "অল্প সময়ে স্পট চেক — ৫ মিনিটের কুইক রাউন্ড।",
    access: "paid",
    freeNote: "ফ্রিতে দৈনিক ৭ বার",
    icon: "/brand/Quick Practice Icon Container.svg",
  },
  {
    title: "লাইভ মডেল টেস্ট",
    desc: "প্রতিদিন একটা, প্রতি শুক্রবার বড় সাপ্তাহিক পরীক্ষা।",
    access: "free",
    icon: "/brand/Mock.svg",
  },
  {
    title: "লাইভ লিডারবোর্ড",
    desc: "জাতীয় ও ব্যাচ-ভিত্তিক — প্রতিটা পরীক্ষার পর তোমার র‌্যাংক।",
    access: "free",
    icon: "/brand/Point_icon.svg",
  },
  {
    title: "ভিডিও ক্লাস",
    desc: "প্রতিটা অধ্যায়ের রেকর্ডেড ক্লাস। অ্যাপ ও ওয়েবে যেকোনো সময়।",
    access: "paid",
    freeNote: "ফ্রি প্লেলিস্ট আছে",
    icon: "/brand/Videos.svg",
  },
  {
    title: "চর্চা কোচ",
    desc: "ভিডিও শেষে interactive Q&A। তোমার উত্তর দেখে adapt করে।",
    access: "free",
    freeNote: "ফ্রি ভিডিওর সাথে ফ্রি",
    icon: "/brand/Chorcha AI.svg",
  },
  {
    title: "প্রোগ্রেস ট্র্যাকিং",
    desc: "Accuracy, অধ্যায়ভিত্তিক রিপোর্ট, ভুল প্রশ্ন তালিকা।",
    access: "free",
    icon: "/brand/Point_icon.svg",
  },
  {
    title: "AI টিউটর",
    desc: "যেকোনো প্রশ্নের ব্যাখ্যা চাও — বাংলায় উত্তর দেবে।",
    access: "free",
    icon: "/brand/Chorcha AI.svg",
  },
];
...
export default async function BatchPage({
  ...
  const cheapest = priceWithDiscount(
    PRICING_TIERS[0].price,
    ...
    <PageLayout>
      ...
      <div className="max-w-7xl mx-auto px-5 grid lg:grid-cols-3 gap-8 pt-10">
        ...
        <div className="lg:col-span-2 flex flex-col">
          ...
          <section
            id="instructors"
            className="py-14 border-b border-[#ffffff10] scroll-mt-28"
          >
            <h2 className="text-xl font-bold text-white mb-2">শিক্ষকগণ</h2>
            <p className="text-sm text-[#71717a] mb-8">
              এই ব্যাচের জন্য নির্ধারিত শিক্ষক।
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              {INSTRUCTORS.map((ins) => (
                <div
                  key={ins.name + ins.subject}
                  className="border border-[#ffffff10] rounded-xl p-5 flex items-start gap-4"
                >
                  <div className="w-14 h-14 rounded-full bg-[#ffffff08] border border-[#ffffff12] shrink-0 overflow-hidden">
                    <Image
                      src={ins.image}
                      alt={ins.name}
                      width={56}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-[#10b981] mt-0.5 font-medium">
                      {ins.subject}
                    </div>
          ...
          >
            ...
            <p className="text-sm text-[#71717a] mb-8">
              ফ্রি ও সাবস্ক্রিপশন — দুটোতেই কী থাকে।
            </p>
              ...
              {FEATURES.map((f) => (
                ...
                >
                  <div className="flex items-center justify-between gap-3 mb-3">
                    ...
                    <FreePaidPill
                      access={f.access as "free" | "paid"}
                      note={f.freeNote}
                    />
                  </div>
                  <p className="text-xs text-[#71717a] leading-relaxed mb-2">
                    {f.desc}
                  </p>
                  {f.freeNote && (
          ...
          >
            ...
            <p className="text-sm text-[#71717a] mb-8">
              আরও প্রশ্ন থাকলে কল করো 16910 (২৪/৭)।
            </p>
            <div className="flex flex-col gap-3">
              {FAQS.map((faq) => (
                <details
                  key={faq.q}
                  className="border border-[#ffffff10] rounded-xl px-5 group"
                >
                  <summary className="py-4 text-sm font-medium text-white cursor-pointer list-none flex items-center justify-between gap-3">
                    {faq.q}
                    <span className="text-[#71717a] group-open:rotate-180 transition-transform shrink-0">
                      ▾
                    </span>
                  </summary>
          ...
          <section className="py-14">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {BATCHES.filter((b) => b.slug !== slug).map((b) => (
                ...
                >
                  <div className="text-sm font-semibold text-white group-hover:text-[#34d399] transition-colors">
                    {b.label}
                  </div>
                  ...
                  <span
                    className={`inline-flex text-[9px] font-medium px-2 py-0.5 rounded-full border mt-2 ${STATUS_COLOR[b.status]}`}
                  >
          ...
          <div className="lg:sticky lg:top-32 border border-[#ffffff10] rounded-2xl flex flex-col bg-[#121212] overflow-hidden">
            ...
            <div className="relative w-full aspect-video bg-[#181818] flex items-center justify-center">
              ...
              <div className="absolute top-2 left-2">
                <span
                  className={`text-[9px] font-semibold px-2 py-0.5 rounded-full border ${STATUS_COLOR[batch.status]}`}
                >
...
function OverviewSection({ batch }: { batch: BatchMeta }) {
  ...
  return (
    <section
      id="overview"
      className="pb-10 border-b border-[#ffffff10] flex flex-col gap-5 scroll-mt-28"
    >
      <div className="flex items-center gap-2 text-xs text-[#71717a]">
        <Link
          href={isHSC ? "/stream/hsc" : "/stream/class-6-10"}
      ...
      <span
        className={`inline-flex w-fit text-[10px] font-semibold px-2.5 py-1 rounded-full border ${STATUS_COLOR[batch.status]}`}
      >
        {STATUS_LABEL[batch.status]}
      </span>
      ...
      <p className="text-sm text-[#a1a1aa] leading-relaxed">
        {batch.tagline}। পরীক্ষা পর্যন্ত সাবস্ক্রিপশনে সব কিছু পাবে — ভিডিও, মক
        টেস্ট, লাইভ পরীক্ষা, কোচ, প্রোগ্রেস।
      </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-2">
        ...
        <div className="border border-[#ffffff10] rounded-xl p-4">
          <div className="text-xs text-[#71717a] mb-1">ভিডিও ক্লাস</div>
          <div className="text-sm font-bold text-white leading-snug">
            রেকর্ডেড ভিডিও
          </div>
          <div className="text-[10px] text-[#71717a] mt-1">
            প্রতিটা অধ্যায়ের জন্য
          </div>
        </div>
        <div className="border border-[#ffffff10] rounded-xl p-4">
          <div className="text-xs text-[#71717a] mb-1">AI কোচ</div>
          <div className="text-sm font-bold text-white leading-snug">
            চর্চা কোচ + AI টিউটর
          </div>
          <div className="text-[10px] text-[#71717a] mt-1">
      ...
      <div className="flex flex-wrap items-center gap-5 mt-2 text-xs text-[#71717a]">
        ...
        <span>
          <span className="text-white font-semibold">
            {batch.totalMockTests}
          </span>{" "}
          পরীক্ষা দেওয়া হয়েছে
        </span>
        <span>
          পরীক্ষা:{" "}
          <span className="text-white font-semibold">{batch.examDate}</span>
        </span>
      </div>
    </section>
  );
...
function LiveTestSection({ batch }: { batch: BatchMeta }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-[#71717a] mb-8">
        প্রতিদিন একটা মডেল টেস্ট, প্রতি শুক্রবার বড় সাপ্তাহিক পরীক্ষা।
      </p>

      {isActive && batch.liveTest && (
        <div className="grid sm:grid-cols-2 gap-4 mb-5">
          <div className="border border-[#10b98130] bg-[#10b98108] rounded-xl p-5">
          ...
          <div className="border border-[#ffffff10] rounded-xl p-5">
            ...
            <h3 className="text-base font-semibold text-white">
              {batch.liveTest.weeklyTopic}
            </h3>
            <p className="text-xs text-[#71717a] mt-1">
              প্রতি {batch.liveTest.weeklyDay} · পূর্ণ সিলেবাস
            </p>
          </div>
        </div>
      )}
...
function ProgressSection() {
  return (
    ...
    >
      ...
      <p className="text-sm text-[#71717a] mb-8">
        প্র্যাকটিসের সবকিছু track হয়। কোথায় দুর্বল, কোন প্রশ্ন ভুল করেছিলে —
        সব এক জায়গায়।
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-5">
        ...
        <div className="border border-[#ffffff10] rounded-xl p-5">
          ...
          <p className="text-[10px] text-[#71717a] mt-4">
            স্কিপড আলাদা — fail হওয়া না, এড়িয়ে যাওয়া। চাপ কম।
          </p>
        </div>
        ...
        <div className="border border-[#ffffff10] rounded-xl p-5">
          ...
          <p className="text-[10px] text-[#71717a] mt-3">
            দুর্বল অধ্যায় চিনে নাও — ভিডিও সাজেস্ট হবে।
          </p>
        </div>
      </div>

      {/* Wrong & Saved questions */}
      <div className="grid sm:grid-cols-2 gap-4">
        <div className="border border-[#ffffff10] rounded-xl p-5">
          ...
          <p className="text-xs text-[#71717a] leading-relaxed mb-4">
            যেগুলো ভুল করেছিলে, সেগুলো হারিয়ে যাবে না। যখন চাও তখন আবার চেষ্টা
            করো।
          </p>
          <div className="flex flex-col gap-2">
            {[
              ...
              <div
                key={q}
                className="flex items-center gap-3 text-xs text-[#a1a1aa] border-l-2 border-amber-400/40 pl-3 py-1.5"
              >
                {q}
              </div>
            ))}
        ...
        <div className="border border-[#ffffff10] rounded-xl p-5">
          <div className="flex items-start justify-between gap-4 mb-3">
            <div>
              ...
              <h3 className="text-sm font-semibold text-white">
                পরে পড়ার জন্য সেভ করা
              </h3>
            </div>
            <span className="text-[10px] font-semibold text-[#10b981] border border-[#10b98130] bg-[#10b98110] px-2 py-0.5 rounded-full whitespace-nowrap">
              ২৩ টি
            </span>
          </div>
          <p className="text-xs text-[#71717a] leading-relaxed mb-4">
            যেকোনো প্রশ্ন সেভ করে রাখো — পরীক্ষার আগে একসাথে রিভাইজ দাও।
          </p>
          <div className="flex flex-col gap-2">
            {[
              "জীববিজ্ঞান · কোষ বিভাজন · প্রশ্ন #৩৩",
              "পদার্থবিজ্ঞান · নিউটনের সূত্র · প্রশ্ন #১২",
              "রসায়ন · অম্ল-ক্ষার · প্রশ্ন #৬৭",
            ].map((q) => (
              <div
                key={q}
                className="flex items-center gap-3 text-xs text-[#a1a1aa] border-l-2 border-[#10b98140] pl-3 py-1.5"
              >
                {q}
              </div>
            ))}
...
function CoachSection() {
  return (
    ...
    >
      ...
      <p className="text-sm text-[#71717a] mb-8">
        ভিডিও শেষে কোচ এসে প্রশ্ন করে — সত্যি বুঝেছ কিনা যাচাই করে।
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-5">
        ...
        <div className="border border-[#ffffff10] rounded-xl p-5">
          <div className="flex items-center gap-2 mb-4">
            <div className="w-8 h-8 rounded-full bg-[#10b981] flex items-center justify-center text-black text-xs font-bold">
              চ
            </div>
          ...
          <div className="flex flex-col gap-2">
            <div className="bg-[#ffffff08] border border-[#ffffff10] rounded-lg rounded-tl-sm px-3 py-2 max-w-[85%] text-xs text-[#e8efe9]">
              তুমি ২টা ভিডিও দেখে শেষ করলে — "ভেক্টরের প্রকারভেদ" আর
              "সূত্রাবলী"। কয়েকটা প্রশ্ন জিজ্ঞেস করি?
            </div>
            ...
            <div className="bg-[#ffffff08] border border-[#ffffff10] rounded-lg rounded-tl-sm px-3 py-2 max-w-[85%] text-xs text-[#e8efe9]">
              <p className="font-medium mb-2">
                দুটি ভেক্টরের মধ্যে কোণ ৬০° হলে, তাদের লব্ধির মান কোনটা?
              </p>
              <div className="flex flex-col gap-1.5">
                <div className="border border-[#ffffff10] rounded px-2 py-1 text-[10px]">
                  ক) √৩
                </div>
                <div className="border border-[#10b981] bg-[#10b98110] rounded px-2 py-1 text-[10px] text-[#10b981]">
                  খ) √৭
                </div>
                <div className="border border-[#ffffff10] rounded px-2 py-1 text-[10px]">
                  গ) ২
        ...
        <div className="border border-[#ffffff10] rounded-xl p-5 flex flex-col gap-4">
          ...
          {[
            {
              t: "প্রশ্ন adapt করে",
              d: "তোমার উত্তর দেখে পরের প্রশ্ন কঠিন/সহজ করে।",
            },
            {
              t: "ভিডিও সাজেস্ট করে",
              d: "যে topic-এ দুর্বল, সেটার ভিডিও সরাসরি দেয়।",
            },
            {
              t: "প্র্যাকটিস সাজেস্ট করে",
              d: "প্রশ্ন ব্যাংক থেকে relevant প্রশ্ন বের করে।",
            },
            {
              t: "তুমিই প্রশ্ন করতে পারো",
              d: "যেকোনো বিষয়ে জিজ্ঞেস করো — বাংলায় উত্তর দেবে।",
            },
          ].map((item) => (
      ...
      <div className="border border-[#ffffff10] rounded-xl p-5 bg-[#10b98108]">
        <p className="text-xs text-[#a1a1aa] leading-relaxed">
          <span className="text-[#10b981] font-semibold">
            ফ্রি ভিডিওর সাথে কোচ ফ্রি।
          </span>{" "}
          সাবস্ক্রিপশন নিলে সব ভিডিওর পর কোচ পাবে।
        </p>
      </div>
    </section>
  );
...
function SyllabusSection({ batch }: { batch: BatchMeta }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-[#71717a] mb-8">
        {isHSC
          ? "বিভাগ অনুযায়ী বিষয়সমূহ। প্রতিটা বিষয় খুলে অধ্যায় ও ভিডিও সংখ্যা দেখো।"
          : "প্রতিটা বিষয় খুলে অধ্যায় ও ভিডিও সংখ্যা দেখো।"}
      </p>
      ...
      {isHSC ? (
        <div className="flex flex-col gap-6">
          {HSC_DIVISIONS.map((div) => (
            <div key={div}>
              <p className="text-[10px] font-semibold text-[#10b981] uppercase tracking-widest mb-3">
                {DIVISION_LABELS[div]}
              </p>
              <SyllabusSubjectList subjects={HSC_SUBJECTS[div]} />
            </div>
          ))}
        </div>
      ) : (
        <SyllabusSubjectList subjects={SSC_SUBJECTS} />
      )}
    </section>
  );
}
  ...
  return (
    ...
    >
      <h2 className="text-xl font-bold text-white mb-2">
        পেমেন্ট ও সাবস্ক্রিপশন
      </h2>
      <p className="text-sm text-[#71717a] mb-8">
        যেকোনো মোবাইল ব্যাংকিং বা কার্ড দিয়ে পেমেন্ট করো।
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="border border-[#ffffff10] rounded-xl p-5">
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div
                key={m.name}
                className="flex items-center justify-between border-b border-[#ffffff08] pb-3 last:border-0 last:pb-0"
              >
                <div>
        ...
        <div className="border border-[#ffffff10] rounded-xl p-5">
          <h3 className="text-sm font-semibold text-white mb-4">
            ফ্রি প্ল্যান কী দেয়?
          </h3>
          <ul className="flex flex-col gap-2.5 text-xs text-[#a1a1aa]">
            <li className="flex items-start gap-2">
              <span className="text-[#10b981] shrink-0 mt-0.5">✓</span> আজীবন
              ৮টি মক টেস্ট
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#10b981] shrink-0 mt-0.5">✓</span> দৈনিক ৭
              বার দ্রুত প্র্যাকটিস
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#10b981] shrink-0 mt-0.5">✓</span> সব লাইভ
              মডেল টেস্ট
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#10b981] shrink-0 mt-0.5">✓</span> সব
              লিডারবোর্ড
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#10b981] shrink-0 mt-0.5">✓</span> ফ্রি
              ভিডিও প্লেলিস্ট + চর্চা কোচ
            </li>
          </ul>
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold text-white">
            এই ব্যাচ ({batch.label}) সম্পন্ন হয়েছে
          </p>
          <p className="text-xs text-[#71717a] mt-1">
            পরীক্ষা: {batch.examDate} · {batch.enrolledStudents} জন উপকৃত হয়েছে
          </p>
        </div>
        <Link
          href="/batches"
